...
<section class="section">
  <div class="container">
    ...
    <br/> <br/>
    <p><a class="btn btn-sm btn-yellow-sm" role="button" href="#">Selengkapnya</a></p>
    </div>

    <div class="col-sm-5">
    <img src="asset/tarif-layanan.png"  alt="Logo" width="600px" style="margin-left:20%;height: 350px; margin-bottom:8%;">
    </div>
    </div>
  </div>
  <br/>
  ...
  <div class="container">
    <div class="row">
    <div class="col-sm-7">
    <img src="asset/bank-garansi.png"  alt="Logo" width="600px" style="height: 350px; margin-bottom:8%;">
    </div>
  ...
  <div class="container">
    ...
    <div class="col-sm-5">
    <img src="asset/referensi-bank.png"  alt="Logo" width="600px" style="margin-left:20%;height: 350px; margin-bottom:8%;">
    </div>
    </div>
  </div>
  <br/>
  ...
  <div class="container">
    <div class="row">
    <div class="col-sm-7">
    <img src="asset/pic-transfer.png"  alt="Logo" width="600px" style="height: 350px; margin-bottom:8%;">
    </div>
 ...
 <br/>
  <div class="container">
    ...
    <div class="col-sm-5">
    <img src="asset/pic-inkaso.png"  alt="Logo" width="550px" style="margin-left:20%;height: 350px; margin-bottom:8%;">
    </div>
    </div>
  </div>
