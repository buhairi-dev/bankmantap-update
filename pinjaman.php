...
<img src="asset/slider23.png">
<ul class="breadcrumb">
<div class="container">
  <li><a href="#">Home</a></li>
  <li>Bisnins</li>
  <li>Pinjaman Mantap</li>
</div>
</ul>
</section>
...
<section class="section">
  <div class="container">
    ...
    <br/> <br/>
    <p><a class="btn btn-sm btn-yellow-sm" role="button" href="kredit-mantap-pensiun.php">Selengkapnya</a></p>
    </div>

    <div class="col-sm-5">
    <img src="asset/pinjaman1.png"  alt="Logo" width="600px" style="margin-left:20%;height: 350px; margin-bottom:8%;">
    </div>
    </div>
  </div>
  ...
  <div class="container">
    <div class="row">
    <div class="col-sm-7">
    <img src="asset/pinjaman2.png"  alt="Logo" width="600px" style="height: 350px; margin-bottom:8%;">
    </div>
  ...
  <div class="container">
    ...
    <br/> <br/>
    <p><a class="btn btn-sm btn-yellow-sm" role="button" href="pinjaman-ritel.php">Selengkapnya</a></p>
    </div>

    <div class="col-sm-5">
    <img src="asset/pinjaman3.png"  alt="Logo" width="600px" style="margin-left:20%;height: 350px; margin-bottom:8%;">
    </div>
    </div>
  </div>
  ...
  <div class="container">
    <div class="row">
    <div class="col-sm-7">
    <img src="asset/pinjaman4.png"  alt="Logo" width="600px" style="height: 350px; margin-bottom:8%;">
    </div>
    ...
    <small>Penyediaan dana yang diberikan kepada pengusaha perorangan/badan usaha untuk membiayai berbagai macam kebutuhan baik untuk kebutuhan investasi, kebutuhan modal kerja</small>
    <br/> <br/>
    <p><a class="btn btn-sm btn-yellow-sm" role="button" href="pinjaman-mikro.php">Berita Mantap</a></p>
    </div>
    </div>
  </div>
...
<div class="container mt-5">
    <div class="col-sm">
		<div class="card card-one">
		  ...
		  <h4><img src="asset/icon/calculator.png"  alt="Logo" width="10%"><strong> Simulasi Tabungan dan Pinjaman</strong></h4>
		  ...
		  <a class="btn btn-primary-sm" role="button" href="simulasi.php">HITUNG SIMULASI</a> 
		  </div>
		</div>
